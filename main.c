...
prompt:
    ...
    printf("(II)\tOperations on Fractions\n");
    printf("   \t------------------------\n");
    printf("\t 10. Addition\n");
    printf("\t 11. Subtraction\n");
    printf("\t 12. Multiplication\n");
    printf("\t 13. Division\n");
    printf("\t 14. Reduce to Simplest Form\n");
    printf("\n");

    printf("(III)\tCOMPUTATION OF PI\n");
    printf("   \t-----------------\n");
    printf("\t 15. Compute Sqrt(10005) using Newton-Raphson Algorithm\n");
    printf("\t 16. Compute Value of PI using Chudnovsky Algorithm\n");
    printf("\n");

    printf("(IV)\tMiscellaneous\n");
    printf("   \t-------------\n");
    printf("\t 17. Set Decimal Precision\n");
